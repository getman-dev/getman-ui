                          ...
                          return (
                            <tr key={param.name} className={slot(t.paramRow)}>
                              <td className="px-4 py-3 whitespace-nowrap">
                                ...
                                {param.deprecated && <span className={`text-[9px] ml-1 ${slot(t.mutedText)}`}>deprecated</span>}
                              </td>
                              <td className="px-4 py-3 whitespace-nowrap">
                                <span className={slot(t.paramType)}>{schema?.type ?? "string"}</span>
                              </td>
                              <td className="px-4 py-3 whitespace-nowrap">
                                {schema?.minimum !== undefined && <span className={`text-[10px] font-mono ${slot(t.mutedText)}`}>min:{schema.minimum}</span>}
                                {schema?.maximum !== undefined && <span className={`text-[10px] font-mono ml-1.5 ${slot(t.mutedText)}`}>max:{schema.maximum}</span>}
                              </td>
                ...
                return (
                  <div key={code}>
                    ...
                    >
                      ...
                      {mediaKey && <span className={`text-[10px] font-mono shrink-0 ${slot(t.mutedText)}`}>{mediaKey}</span>}
                      {hasContent && (
                        <svg
