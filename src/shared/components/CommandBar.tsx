              ...
              {group.items.map((item, j) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && (
                      <svg className={slot(t.activeChevron)} fill="none" stroke="currentColor" viewBox="0 0 24 24">
