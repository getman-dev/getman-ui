...
export const darkTheme: AppTheme = {
    ...
    nav: {
        ...
        tab: {
            base: 'px-2.5 py-1 text-[11px] font-medium rounded transition-colors text-gray-500 hover:text-gray-300',
            active: 'bg-gray-700 text-gray-200 border border-gray-600 shadow-sm'
        },
        ...
        endpointItem: {
            base: 'nav-endpoint w-full flex items-center gap-2.5 px-4 py-2 text-left transition-colors text-gray-400 hover:bg-gray-700/50 hover:text-gray-200',
        ...
        schemaItem: {
            base: 'w-full text-left gap-2.5 px-4 py-2 transition-colors hover:bg-gray-700/50',
            active: 'bg-gray-700'
        },
    ...
    themePicker: {
        ...
        item: {
            base: 'w-full flex items-center gap-3 px-3 py-2 text-left hover:bg-gray-700/50 transition-colors',
            active: 'bg-gray-700'
        },
    ...
    playground: {
        ...
        fileInputButton: {
            base: 'file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-medium file:bg-blue-900/40 file:text-blue-400 hover:file:bg-blue-900/60',
            hasFile: 'file:bg-blue-900/60'
        },
        ...
        sendButton: {
            ...
            loading: 'bg-gray-700 text-gray-500 cursor-not-allowed shadow-none',
            disabled: 'bg-gray-700 text-gray-500 cursor-not-allowed shadow-none'
        },
        responsePanel: 'h-full border-t border-gray-700 flex flex-col',
        responseStatus: {
            base: 'text-[10px] rounded px-1.5 py-0.5 font-mono font-semibold border bg-gray-800 text-gray-400 border-gray-600',
            success: 'bg-green-900/30 text-green-400 border-green-700',
            redirect: 'bg-blue-900/30 text-blue-400 border-blue-700',
            clientError: 'bg-amber-900/30 text-amber-400 border-amber-700',
            serverError: 'bg-red-900/30 text-red-400 border-red-700'
        },
    ...
    paneHandle: 'border-l border-gray-700 group-hover:border-blue-400 group-[.dragging]:border-blue-500 transition-colors duration-150',
