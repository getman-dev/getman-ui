...
export const lightTheme: AppTheme = {
  ...
  commandBar: {
    ...
    resultItem:     { base: 'w-full flex items-center gap-3 px-4 py-2.5 text-left transition-colors hover:bg-gray-50', active: 'bg-blue-50 hover:bg-blue-50' },
    actionIcon:     { base: 'w-7 h-7 rounded-md flex items-center justify-center shrink-0 bg-gray-100 text-gray-500', active: 'bg-blue-100 text-blue-600' },
  ...
  responsePanel: {
    ...
    tab:           { base: 'px-2.5 py-1 text-[10px] rounded font-medium transition-colors text-gray-400 hover:text-gray-600', active: 'bg-white shadow-sm text-gray-700 border border-gray-200' },
    tabDivider:    'w-px h-3 bg-gray-200 mx-1',
    headerCount:   'ml-0.5 text-gray-300',
    copyButton:    { base: 'flex items-center gap-1 text-[10px] px-2 py-1 rounded hover:bg-gray-100 transition-colors text-gray-400 hover:text-gray-700', copied: 'text-green-600' },
