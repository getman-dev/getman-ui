...
export const notebookTheme: AppTheme = {
  ...
  nav: {
    ...
    tab:               { base: 'px-2.5 py-1 text-[11px] font-medium rounded-sm transition-colors text-[#9A9182] hover:text-[#1A1814]', active: 'bg-[#F5E642] text-[#3D3520] border border-[#D4C200] shadow-sm' },
    ...
    endpointItem:      { base: 'nav-endpoint w-full flex items-center gap-2.5 px-4 py-2 text-left transition-colors text-[#5C5548] hover:bg-[#E8E3D9]/60 hover:text-[#1A1814]', active: 'bg-[#F5E642]/40 text-[#1A1814]' },
    endpointPath:      'truncate text-[11px] font-mono',
    methodBadge:       { base: badge, get: 'bg-[#DFF0D8] text-[#3A6B30]', post: 'bg-[#F5E642] text-[#3D3520]', put: 'bg-[#FFF3C0] text-[#7A5A00]', delete: 'bg-[#FFE0E0] text-[#8B2020]', patch: 'bg-[#FFE8D0] text-[#7A3A00]', options: 'bg-[#E8E3D9] text-[#5C5548]', head: 'bg-[#E8E3D9] text-[#5C5548]' },
    schemaItem:        { base: 'w-full text-left gap-2.5 px-4 py-2 transition-colors hover:bg-[#E8E3D9]/60', active: 'bg-[#F5E642]/40' },
  ...
  endpoint: {
    ...
    responseStatusCode:  { base: 'text-xs font-mono font-semibold', success: 'text-[#3A6B30]', redirect: 'text-[#2A5A8B]', clientError: 'text-[#7A5A00]', serverError: 'text-[#8B2020]' },
  ...
  themePicker: {
    ...
    item:     { base: 'w-full flex items-center gap-3 px-3 py-2 text-left hover:bg-[#F0ECE3] transition-colors', active: 'bg-[#F5E642]/30' },
  ...
  commandBar: {
    ...
    resultItem:     { base: 'w-full flex items-center gap-3 px-4 py-2.5 text-left transition-colors hover:bg-[#F0ECE3]', active: 'bg-[#F5E642]/30 hover:bg-[#F5E642]/30' },
    actionIcon:     { base: 'w-7 h-7 rounded-sm flex items-center justify-center shrink-0 bg-[#F0ECE3] text-[#5C5548]', active: 'bg-[#F5E642]/40 text-[#3D3520]' },
  ...
  playground: {
    ...
    fileInputButton:     { base: 'file:py-1.5 file:px-3 file:rounded-sm file:border-0 file:text-xs file:font-medium file:bg-[#F5E642]/40 file:text-[#3D3520] hover:file:bg-[#F5E642]/60', hasFile: 'file:bg-[#F5E642]/60' },
    ...
    sendButton:          { base: 'shrink-0 px-4 rounded-sm text-xs font-semibold transition-all bg-[#F5E642] hover:bg-[#E6D800] active:scale-[0.98] text-[#3D3520] shadow-sm', loading: 'bg-[#F0ECE3] text-[#9A9182] cursor-not-allowed shadow-none', disabled: 'bg-[#F0ECE3] text-[#9A9182] cursor-not-allowed shadow-none' },
    responsePanel:       'h-full border-t border-[#D6D0C4] flex flex-col',
    responseStatus:      { base: 'text-[10px] rounded-sm px-1.5 py-0.5 font-mono font-semibold border bg-[#F0ECE3] text-[#5C5548] border-[#D6D0C4]', success: 'bg-[#DFF0D8] text-[#3A6B30] border-[#A8C8A0]', redirect: 'bg-[#D8E8F8] text-[#2A5A8B] border-[#A0B8D0]', clientError: 'bg-[#FFF3C0] text-[#7A5A00] border-[#D4C200]', serverError: 'bg-[#FFE0E0] text-[#8B2020] border-[#C8A0A0]' },
    ...
    responseTab:         { base: 'px-2.5 py-1 text-[10px] rounded-sm font-medium transition-colors text-[#9A9182] hover:text-[#1A1814]', active: 'bg-[#FDFCF9] shadow-sm text-[#1A1814] border border-[#D6D0C4]' },
  ...
  responsePanel: {
    ...
    tab:           { base: 'px-2.5 py-1 text-[10px] rounded-sm font-medium transition-colors text-[#9A9182] hover:text-[#1A1814]', active: 'bg-[#FDFCF9] shadow-sm text-[#1A1814] border border-[#D6D0C4]' },
    tabDivider:    'w-px h-3 bg-[#D6D0C4] mx-1',
    headerCount:   'ml-0.5 text-[#C5BFAD]',
    copyButton:    { base: 'flex items-center gap-1 text-[10px] px-2 py-1 rounded-sm hover:bg-[#F0ECE3] transition-colors text-[#9A9182] hover:text-[#1A1814]', copied: 'text-[#3A6B30]' },
